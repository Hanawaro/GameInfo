<div class="article">
                ...
                <div class="dropdown">
                    <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                       data-toggle="dropdown" aria-expanded="false">
                        ...
                        <svg fill="currentColor" height="20" width="20" class="svg-icon"><path fill-rule="evenodd" clip-rule="evenodd" d="M5 10C5 11.1046 4.10457 12 3 12C1.89543 12 1 11.1046 1 10C1 8.89543 1.89543 8 3 8C4.10457 8 5 8.89543 5 10ZM12 10C12 11.1046 11.1046 12 10 12C8.89543 12 8 11.1046 8 10C8 8.89543 8.89543 8 10 8C11.1046 8 12 8.89543 12 10ZM17 12C18.1046 12 19 11.1046 19 10C19 8.89543 18.1046 8 17 8C15.8954 8 15 8.89543 15 10C15 11.1046 15.8954 12 17 12Z"></path></svg>
                    </a>

                    <form method="POST" action="{{ route('article.delete', $article->id) }}" class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        @csrf
    ...
    @foreach($article->previews()->get() as $element)
        ...
        @if($element == $article->previews()->first())
            <a href="">
                @endif
    ...
    <a class="read-more btn btn-outline-primary" href="{{ route('article.get', $article->id) }}">Читать далее</a>
